...
// node_modules/@thirdweb-dev/sdk/dist/sdk-df34da7e.browser.esm.js
init_shim();
...
var UserWallet = class {
  ...
  async transfer(to, amount) {
    ...
    if (isNativeToken(resolvedCurrency)) {
      ...
      const ERC20Abi = (await import("./IERC20-GTJQJX2O.js")).default;
      return {
...
var ThirdwebSDK = class extends RPCConnectionHandler {
  ...
  async getContractFromAbi(address, abi) {
    const [resolvedAddress, {
      SmartContract
    }] = await Promise.all([resolveAddress(address), import("./smart-contract-d36a4322.browser.esm-R4SLNJVM.js")]);
    if (this.contractCache.has(resolvedAddress)) {
      return this.contractCache.get(resolvedAddress);
    }
...
var ContractDeployer = class extends RPCConnectionHandler {
  constructor(network, options, storage) {
    ...
    __publicField(this, "deployProxy", buildDeployTransactionFunction(async (implementationAddress, implementationAbi, initializerFunction, initializerArgs) => {
      ...
      const {
        TWProxy__factory
      } = await import("./thirdweb-dev-contracts-js-factories-TWProxy__factory.browser.esm-DLFBATZJ.js");
...
${bytecode}`);
  ...
  async getRegistry() {
    ...
    return this._registry = this.getProvider().getNetwork().then(async (_ref2) => {
      ...
      const TWRegistryABI = (await import("./TWRegistry-OYWTM747.js")).default;
...
// node_modules/@thirdweb-dev/sdk/dist/token-49700b4f.browser.esm.js
init_shim();
init_lib();
...
// node_modules/@thirdweb-dev/sdk/dist/watchTransactions-09fb9b50.browser.esm.js
init_shim();
init_lib();
...
async function getContractFromAbi(params) {
  ...
  const [resolvedAddress, {
    ...
    SmartContract
  }] = await Promise.all([resolveAddress(params.address), provider.getNetwork(), import("./smart-contract-d36a4322.browser.esm-R4SLNJVM.js")]);
...
async function getContract(params) {
  ...
  }] = await Promise.all([resolveAddress(params.address), provider.getNetwork(), import("./contract-publisher-b59ae25e.browser.esm-6S7E4YOH.js").then(function(n) {
    return n.c;
  })]);
  if (inContractCache(resolvedAddress, chainId)) {
    return getCachedContract(resolvedAddress, chainId);
...
//# sourceMappingURL=chunk-5WVVQIJW.js.map
