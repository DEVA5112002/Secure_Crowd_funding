...
var BaseAccountAPI = class {
  ...
  async createUnsignedUserOp(httpRpcClient, info, options) {
    ...
    const value = (_a = parseNumber(info.value)) != null ? _a : BigNumber.from(0);
    const callData = (options == null ? void 0 : options.batchData) ? info.data : await this.prepareExecute(info.target, value, info.data).then((tx) => tx.encode());
    let {
      maxFeePerGas,
    ...
    if (!maxFeePerGas || !maxPriorityFeePerGas) {
      ...
      if (!maxFeePerGas) {
        maxFeePerGas = (_c = feeData.maxFeePerGas) != null ? _c : void 0;
...
//# sourceMappingURL=chunk-JLLZHO4D.js.map
