...
import {
  ...
  useWalletConnect,
  useWalletConnectV1
} from "./chunk-T32CEREN.js";
import {
  walletConnectV1
} from "./chunk-4IJBPA25.js";
import {
  magicLink
} from "./chunk-DQM3ODMG.js";
import "./chunk-MEZFAHUE.js";
import {
  safeWallet
} from "./chunk-REH5252Z.js";
import {
  frameWallet
} from "./chunk-J52ODG44.js";
import {
  ConnectingScreen,
...
import "./chunk-S5MW2NDX.js";
import "./chunk-RSK7R2KP.js";
import "./chunk-6KCAJ4F5.js";
import {
  getInjectedCoin98Provider
} from "./chunk-GMJ2LSFM.js";
import "./chunk-R7DYC6N5.js";
import {
...
import "./chunk-KU45NJHX.js";
import "./chunk-IZWHDSTB.js";
import "./chunk-JMY4HDQL.js";
import {
...
import "./chunk-7NOJMCWO.js";
import "./chunk-IM5F35UJ.js";
...
// node_modules/@thirdweb-dev/react/dist/useSafe-88e40fe2.browser.esm.js
init_shim();
...
function useSafe() {
  ...
  return (0, import_react.useCallback)(async (connectProps) => {
    ...
    } = await import("./safeWallet-959085a5.browser.esm-OCOINV64.js");
    return connect(safeWallet2(), connectProps);
  }, [connect]);
}

// node_modules/@thirdweb-dev/react/dist/useMagic-ffb2a195.browser.esm.js
init_shim();
...
function useMagic() {
  ...
  return (0, import_react2.useCallback)(async (options) => {
    ...
    } = await import("./magicLink-fc223d8c.browser.esm-BYURWO7P.js");
...
var getPaperOriginUrl = () => {
  var _a;
  if (isDev()) {
    return (_a = window.localStorage.getItem("PAPER_DEV_URL")) != null ? _a : "http://localhost:3000";
  }
  if (isOldPaperDomain()) {
...
function createCheckoutWithCardLink(_ref) {
  ...
  checkoutWithCardLink.addClientId(clientId != null ? clientId : "");
  checkoutWithCardLink.addClientSecret(clientSecret != null ? clientSecret : "");
