...
// node_modules/@thirdweb-dev/sdk/dist/marketplacev3-offers-fe140fbf.browser.esm.js
init_shim();
init_lib();
...
var MarketplaceV3DirectListings = class {
  ...
  async isStillValidListing(listing, quantity) {
    ...
    const ERC165Abi = (await import("./IERC165-5OCLDTS7.js")).default;
    const erc165 = new Contract(listing.assetContractAddress, ERC165Abi, provider);
    const isERC721 = await erc165.supportsInterface(InterfaceId_IERC721);
    const isERC1155 = await erc165.supportsInterface(InterfaceId_IERC1155);
    if (isERC721) {
      const ERC721Abi = (await import("./IERC721-X7G2JO67.js")).default;
      ...
      const ERC1155Abi = (await import("./IERC1155-E7SCCCL3.js")).default;
...
//# sourceMappingURL=chunk-XXU6U6RC.js.map
