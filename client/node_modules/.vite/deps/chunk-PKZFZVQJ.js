...
import {
  init_sha256,
  sha256
} from "./chunk-EE55PL3Y.js";
import {
  eventemitter3_default
} from "./chunk-NBFJ3KHJ.js";
import {
  IERC721Metadata_default
} from "./chunk-DHMVYZV7.js";
import {
  IERC1155_default
} from "./chunk-7DQHQEI5.js";
import {
  IERC1155Metadata_default
} from "./chunk-UVXELCFU.js";
import {
  Contract,
...
import {
  IERC20_default
} from "./chunk-HZQFHQLI.js";
import {
  IERC20Metadata_default
} from "./chunk-RW4LJ3ZA.js";
import {
  IERC721_default
} from "./chunk-YDRBHGWK.js";
import {
  c10,
  c11155420,
  c1220,
...
// node_modules/@thirdweb-dev/sdk/dist/transactions-1e556889.browser.esm.js
init_shim();

// node_modules/@thirdweb-dev/sdk/dist/index-6805b358.browser.esm.js
init_shim();
init_lib();
    ...
    if (match) {
      switch (match[1].toLowerCase()) {
        ...
        case "https":
          ...
          }, chainId, sdkOptions == null ? void 0 : sdkOptions.rpcBatchSettings) : new lib_exports2.JsonRpcBatchProvider({
            url: rpcUrl,
            headers,
            skipFetchSetup: _skipFetchSetup
          });
...
async function fetchPublishedContractFromPolygon(publisherAddress, contractName) {
  ...
  const ContractPublisherAbi = (await import("./ContractPublisher-YOG5NBN3.js")).default;
...
async function getPrebuiltInfo(address, provider2) {
  try {
    const IThirdwebContractABI = (await import("./IThirdwebContract-JC6IGGDF.js")).default;
...
async function getMetadataUriFromMultichainRegistry(address, chainId, sdkOptions) {
  var _a;
  const TWRegistryABI = (await import("./TWMultichainRegistryLogic-CUHHGHNY.js")).default;
...
Expected function signature: ${functions[0].signature}`);
  ...
  async enginePrepareRequest(transaction) {
    ...
    if (transaction.functionName === "approve" && transaction.functionArgs.length === 2) {
      ...
      const ForwarderABI = (await import("./Forwarder-AY4RQA72.js")).default;
...
var EditionDropInitializer = {
  ...
  initialize: async function() {
    ...
    const [abi, contract, _network] = await Promise.all([EditionDropInitializer.getAbi(address, provider2, storage), import("./edition-drop-3be72ea3.browser.esm-SB44D4CY.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    return !contractInfo || contractInfo.version > 2 ? (await import("./DropERC1155-RXPD235I.js")).default : (await import("./DropERC1155_V2-34BQONI2.js")).default;
  }
};
var EditionInitializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([EditionInitializer.getAbi(address, provider2, storage), import("./edition-4fa5f7b4.browser.esm-BXB6HP3K.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    return (await import("./TokenERC1155-VQKOBEPQ.js")).default;
  }
};
var MarketplaceInitializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([MarketplaceInitializer.getAbi(address, provider2, storage), import("./marketplace-61b99f44.browser.esm-JR7MBILT.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    return (await import("./Marketplace-XPGZPQSG.js")).default;
  }
};
var MarketplaceV3Initializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([MarketplaceV3Initializer.getAbi(address, provider2, storage, options), import("./marketplacev3-4c6e87bd.browser.esm-6SRSC4Y7.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage, options) => {
    ...
    const localAbi = (await import("./MarketplaceV3-SUXWZUTG.js")).default;
...
var MultiwrapInitializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([MultiwrapInitializer.getAbi(address, provider2, storage), import("./multiwrap-8e46e963.browser.esm-M7NPCRXU.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    return (await import("./Multiwrap-E6DGBICT.js")).default;
  }
};
var NFTCollectionInitializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([NFTCollectionInitializer.getAbi(address, provider2, storage), import("./nft-collection-432afc19.browser.esm-ZPR4PCVP.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    return (await import("./TokenERC721-GSMLDKD4.js")).default;
  }
};
var NFTDropInitializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([NFTDropInitializer.getAbi(address, provider2, storage), import("./nft-drop-8f133459.browser.esm-PDZPOKNO.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    const contractInfo = await getContractInfo(address, provider2);
    return !contractInfo || contractInfo.version > 3 ? (await import("./DropERC721-3MDDVHZU.js")).default : (await import("./DropERC721_V3-NRJEKCJF.js")).default;
  }
};
var PackInitializer = {
  name: "Pack",
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([PackInitializer.getAbi(address, provider2, storage), import("./pack-7e6b83c4.browser.esm-UDXPHUEA.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    return AbiSchema.parse((await import("./Pack-WQ3DMVVM.js")).default || []);
  }
};
var SignatureDropInitializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([SignatureDropInitializer.getAbi(address, provider2, storage), import("./signature-drop-7e239c11.browser.esm-2SPFU3DG.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    const contractInfo = await getContractInfo(address, provider2);
    return !contractInfo || contractInfo.version > 4 ? (await import("./SignatureDrop-Z52RFMKY.js")).default : (await import("./SignatureDrop_V4-GIU53ACC.js")).default;
  }
};
var SplitInitializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([SplitInitializer.getAbi(address, provider2, storage), import("./split-2aca2e9c.browser.esm-XNIZOCPB.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    return (await import("./Split-6E4IDEBS.js")).default;
  }
};
var TokenDropInitializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([TokenDropInitializer.getAbi(address, provider2, storage), import("./token-drop-b1dfc47e.browser.esm-EOGPA6XX.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    const contractInfo = await getContractInfo(address, provider2);
    return !contractInfo || contractInfo.version > 2 ? (await import("./DropERC20-6AO2Q2SP.js")).default : (await import("./DropERC20_V2-C2U36NDE.js")).default;
  }
};
var TokenInitializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([TokenInitializer.getAbi(address, provider2, storage), import("./token-22486bf6.browser.esm-XEKWRYYQ.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    return (await import("./TokenERC20-RV4U3F6O.js")).default;
  }
};
var VoteInitializer = {
  name: "VoteERC20",
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([VoteInitializer.getAbi(address, provider2, storage), import("./vote-5a9144eb.browser.esm-AXCDOBTL.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    return (await import("./VoteERC20-LKARFQUG.js")).default;
  }
};
...
function isOpStackChain(chainId) {
  return chainId === c10.chainId || chainId === c11155420.chainId || chainId === c8453.chainId || chainId === c84532.chainId || chainId === c7777777.chainId || chainId === c999999999.chainId;
}
 ...
 * @license MIT
 */
//# sourceMappingURL=chunk-PKZFZVQJ.js.map
