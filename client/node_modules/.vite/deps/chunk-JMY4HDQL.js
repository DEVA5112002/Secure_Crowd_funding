import {
  ...
  init_to_string,
  toString
} from "./chunk-D7LH2CO4.js";
import {
  require_crypto_browserify
} from "./chunk-25XO4EF6.js";
import {
  require_events
...
var require_sha256 = __commonJS({
  "node_modules/@stablelib/sha256/lib/sha256.js"(exports) {
    ...
    function hashBlocks(w5, v3, p3, pos, len) {
      while (len >= 64) {
        var a3 = v3[0];
        var b4 = v3[1];
        var c3 = v3[2];
        ...
        for (var i2 = 0; i2 < 16; i2++) {
          var j3 = pos + i2 * 4;
          w5[i2] = binary_1.readUint32BE(p3, j3);
        }
        ...
        for (var i2 = 0; i2 < 64; i2++) {
          var t1 = (((e >>> 6 | e << 32 - 6) ^ (e >>> 11 | e << 32 - 11) ^ (e >>> 25 | e << 32 - 25)) + (e & f2 ^ ~e & g5) | 0) + (h4 + (K3[i2] + w5[i2] | 0) | 0) | 0;
...
var require_x25519 = __commonJS({
  "node_modules/@stablelib/x25519/lib/x25519.js"(exports) {
    ...
    function scalarMult(n2, p3) {
      ...
      const a3 = gf(), b4 = gf(), c3 = gf(), d2 = gf(), e = gf(), f2 = gf();
    ...
    (function(factory) {
      ...
      __generator = function(thisArg, body) {
        ...
        function step(op) {
          ...
          while (_3)
            try {
              if (f2 = 1, y4 && (t = op[0] & 2 ? y4["return"] : op[0] ? y4["throw"] || ((t = y4["return"]) && t.call(y4), 0) : y4.next) && !(t = t.call(y4, op[1])).done)
                return t;
              if (y4 = 0, t)
                op = [op[0] & 2, t.value];
              switch (op[0]) {
      ...
      __asyncGenerator = function(thisArg, _arguments, generator) {
        ...
        var g5 = generator.apply(thisArg, _arguments || []), i2, q2 = [];
          ...
          if (g5[n2])
            i2[n2] = function(v3) {
              return new Promise(function(a3, b4) {
                q2.push([n2, v3, a3, b4]) > 1 || resume(n2, v3);
              });
            };
        }
      ...
      __asyncDelegator = function(o) {
        ...
        function verb(n2, f2) {
          i2[n2] = o[n2] ? function(v3) {
            return (p3 = !p3) ? { value: __await(o[n2](v3)), done: n2 === "return" } : f2 ? f2(v3) : v3;
          } : f2;
        }
      };
...
var require_ed25519 = __commonJS({
  "node_modules/@stablelib/ed25519/lib/ed25519.js"(exports) {
    ...
    function edadd(p3, q2) {
      const a3 = gf(), b4 = gf(), c3 = gf(), d2 = gf(), e = gf(), f2 = gf(), g5 = gf(), h4 = gf(), t = gf();
      sub(a3, p3[1], p3[0]);
      sub(t, q2[1], q2[0]);
      mul(a3, a3, t);
      add(b4, p3[0], p3[1]);
...
function Hi(n2, e) {
  ...
  function p3(u3) {
    ...
    for (var m2 = 0, z2 = 0, I2 = 0, _3 = u3.length; I2 !== _3 && u3[I2] === 0; )
      I2++, m2++;
    for (var T = (_3 - I2) * d2 + 1 >>> 0, f2 = new Uint8Array(T); I2 !== _3; ) {
      for (var S3 = u3[I2], A2 = 0, C = T - 1; (S3 !== 0 || A2 < z2) && C !== -1; C--, A2++)
        S3 += 256 * f2[C] >>> 0, f2[C] = S3 % a3 >>> 0, S3 = S3 / a3 >>> 0;
      if (S3 !== 0)
        throw new Error("Non-zero carry");
      z2 = A2, I2++;
    }
    for (var x3 = T - z2; x3 !== T && f2[x3] === 0; )
      x3++;
    for (var j3 = h4.repeat(m2); x3 < T; ++x3)
      j3 += n2.charAt(f2[x3]);
    return j3;
  }
  function y4(u3) {
    ...
    if (u3[m2] !== " ") {
      for (var z2 = 0, I2 = 0; u3[m2] === h4; )
        z2++, m2++;
      for (var _3 = (u3.length - m2) * l2 + 1 >>> 0, T = new Uint8Array(_3); u3[m2]; ) {
        var f2 = t[u3.charCodeAt(m2)];
        if (f2 === 255)
          return;
        for (var S3 = 0, A2 = _3 - 1; (f2 !== 0 || S3 < I2) && A2 !== -1; A2--, S3++)
          f2 += a3 * T[A2] >>> 0, T[A2] = f2 % 256 >>> 0, f2 = f2 / 256 >>> 0;
        if (f2 !== 0)
          throw new Error("Non-zero carry");
        I2 = S3, m2++;
      }
      if (u3[m2] !== " ") {
        for (var C = _3 - I2; C !== _3 && T[C] === 0; )
          C++;
        for (var x3 = new Uint8Array(z2 + (_3 - C)), j3 = z2; C !== _3; )
          x3[j3++] = T[C++];
        return x3;
      }
    }
  ...
  return { encode: p3, decodeUnsafe: y4, decode: M3 };
}
var Ji = Hi;
var Xi = Ji;
var Ne = (n2) => {
...
var Ks = W2({ prefix: "\u{1F680}", name: "base256emoji", encode: Ms, decode: ks });
...
var xt2 = class {
  constructor(e, t, i2) {
    this.core = e, this.logger = t, this.name = et, this.initialized = false, this.init = async () => {
      ...
      if (qn(a3)) {
        const y4 = a3.senderPublicKey, M3 = a3.receiverPublicKey;
        s = await this.generateSharedKey(y4, M3);
      }
...
var vr = class extends u {
  constructor(e, t) {
    super(e, t), this.relayer = e, this.logger = t, this.events = new import_events5.EventEmitter(), this.name = at2, this.queue = /* @__PURE__ */ new Map(), this.publishTimeout = (0, import_time3.toMiliseconds)(import_time3.TEN_SECONDS * 2), this.needsTransportRestart = false, this.publish = async (i2, s, r) => {
      ...
      try {
        const a3 = (r == null ? void 0 : r.ttl) || ot2, h4 = vt(r), l2 = (r == null ? void 0 : r.prompt) || false, d2 = (r == null ? void 0 : r.tag) || 0, p3 = (r == null ? void 0 : r.id) || getBigIntRpcId().toString(), y4 = { topic: i2, message: s, opts: { ttl: a3, relay: h4, prompt: l2, tag: d2, id: p3 } }, M3 = setTimeout(() => this.queue.set(p3, y4), this.publishTimeout);
        try {
          await await ut(this.rpcPublish(i2, s, a3, h4, l2, d2, p3), this.publishTimeout, `Failed to publish payload, please try again. id:${p3} tag:${d2}`), this.removeRequestFromQueue(p3), this.relayer.events.emit(D3.publish, y4);
        } catch (u3) {
  ...
  rpcPublish(e, t, i2, s, r, o, a3) {
    var h4, l2, d2, p3;
    const y4 = { method: Et(s.protocol).publish, params: { topic: e, message: t, ttl: i2, prompt: r, tag: o }, id: a3 };
    return w((h4 = y4.params) == null ? void 0 : h4.prompt) && ((l2 = y4.params) == null || delete l2.prompt), w((d2 = y4.params) == null ? void 0 : d2.tag) && ((p3 = y4.params) == null || delete p3.tag), this.logger.debug("Outgoing Relay Payload"), this.logger.trace({ type: "message", direction: "outgoing", request: y4 }), this.relayer.request(y4);
  }
  ...
  constructor(r) {
    super(r), this.name = le3, this.events = new import_events6.default(), this.initialized = false, this.ignoredPayloadTypes = [_], this.requestQueue = { state: I.idle, queue: [] }, this.sessionRequestQueue = { state: I.idle, queue: [] }, this.requestQueueDelay = import_time4.ONE_SECOND, this.init = async () => {
      ...
      if (c3 && (d2 = this.client.core.pairing.pairings.get(c3).active), !c3 || !d2) {
        const { topic: T, uri: _3 } = await this.client.core.pairing.create();
        c3 = T, p3 = _3;
      }
      const h4 = await this.client.core.crypto.generateKeyPair(), N4 = R3.wc_sessionPropose.req.ttl || import_time4.FIVE_MINUTES, m2 = pt(N4), f2 = g4({ requiredNamespaces: i2, optionalNamespaces: n2, relays: a3 != null ? a3 : [{ protocol: ht2 }], proposer: { publicKey: h4, metadata: this.client.metadata }, expiryTimestamp: m2 }, o && { sessionProperties: o }), { reject: k3, resolve: O4, done: we } = at(N4, ae2);
      if (this.events.once(yt("session_connect"), async ({ error: T, session: _3 }) => {
        if (T)
          k3(T);
        else if (_3) {
          _3.self.publicKey = h4;
          const B3 = D4(g4({}, _3), { requiredNamespaces: f2.requiredNamespaces, optionalNamespaces: f2.optionalNamespaces });
          await this.client.session.set(_3.topic, B3), await this.setExpiry(_3.topic, _3.expiry), c3 && await this.client.core.pairing.updateMetadata({ topic: c3, metadata: _3.peer.metadata }), O4(B3);
        }
      }), !c3) {
        const { message: T } = N("NO_MATCHING_KEY", `connect() pairing topic: ${c3}`);
        throw new Error(T);
      }
      const W3 = await this.sendRequest({ topic: c3, method: "wc_sessionPropose", params: f2, throwOnFailedPublish: true });
      return await this.setProposal(W3, g4({ id: W3 }, f2)), { uri: p3, approval: we };
      ...
      a3 = a3 || "";
      const h4 = await this.client.core.crypto.generateKeyPair(), N4 = c3.publicKey, m2 = await this.client.core.crypto.generateSharedKey(h4, N4);
      a3 && s && (await this.client.core.pairing.updateMetadata({ topic: a3, metadata: c3.metadata }), await this.sendResult({ id: s, topic: a3, result: { relay: { protocol: t != null ? t : "irn" }, responderPublicKey: h4 } }), await this.client.proposal.delete(s, U("USER_DISCONNECTED")), await this.client.core.pairing.activate({ topic: a3 }));
      const f2 = g4({ relay: { protocol: t != null ? t : "irn" }, namespaces: i2, pairingTopic: a3, controller: { publicKey: h4, metadata: this.client.metadata }, expiry: pt(L3) }, n2 && { sessionProperties: n2 });
      await this.client.core.relayer.subscribe(m2);
      const k3 = D4(g4({}, f2), { topic: m2, requiredNamespaces: p3, optionalNamespaces: d2, pairingTopic: a3, acknowledged: false, self: f2.controller, peer: { publicKey: c3.publicKey, metadata: c3.metadata }, controller: h4 });
      await this.client.session.set(m2, k3);
      try {
        await this.sendRequest({ topic: m2, method: "wc_sessionSettle", params: f2, throwOnFailedPublish: true });
      } catch (O4) {
        throw this.client.logger.error(O4), this.client.session.delete(m2, U("USER_DISCONNECTED")), await this.client.core.relayer.unsubscribe(m2), O4;
      }
      return await this.setExpiry(m2, pt(L3)), { topic: m2, acknowledged: () => new Promise((O4) => setTimeout(() => O4(this.client.session.get(m2)), 500)) };
    }, this.reject = async (e) => {
      ...
      const { chainId: s, request: t, topic: i2, expiry: n2 = R3.wc_sessionRequest.req.ttl } = e, o = payloadId(), { done: a3, resolve: c3, reject: p3 } = at(n2, "Request expired. Please try again.");
      return this.events.once(yt("session_request", o), ({ error: d2, result: h4 }) => {
        d2 ? p3(d2) : c3(h4);
      }), await Promise.all([new Promise(async (d2) => {
        await this.sendRequest({ clientRpcId: o, topic: i2, method: "wc_sessionRequest", params: { request: D4(g4({}, t), { expiryTimestamp: pt(n2) }), chainId: s }, expiry: n2, throwOnFailedPublish: true }).catch((h4) => p3(h4)), this.client.events.emit("session_request_sent", { topic: i2, request: t, chainId: s, id: o }), d2();
      ...
      if (D() && he3.includes(t)) {
        const N4 = Ln(JSON.stringify(p3));
        this.client.core.verify.register({ attestationId: N4 });
      }
      const d2 = await this.client.core.crypto.encode(s, p3), h4 = R3[t].req;
      return n2 && (h4.ttl = n2), o && (h4.id = o), this.client.core.history.set(s, p3), c3 ? (h4.internal = D4(g4({}, h4.internal), { throwOnFailedPublish: true }), await this.client.core.relayer.publish(s, d2, h4)) : this.client.core.relayer.publish(s, d2, h4).catch((N4) => this.client.logger.error(N4)), p3.id;
    }, this.sendResult = async (e) => {
      const { id: s, topic: t, result: i2, throwOnFailedPublish: n2 } = e, o = formatJsonRpcResult(s, i2), a3 = await this.client.core.crypto.encode(t, o), c3 = await this.client.core.history.get(t, s), p3 = R3[c3.request.method].res;
      n2 ? (p3.internal = D4(g4({}, p3.internal), { throwOnFailedPublish: true }), await this.client.core.relayer.publish(t, a3, p3)) : this.client.core.relayer.publish(t, a3, p3).catch((d2) => this.client.logger.error(d2)), await this.client.core.history.resolve(o);
...
***************************************************************************** */
//# sourceMappingURL=chunk-JMY4HDQL.js.map
