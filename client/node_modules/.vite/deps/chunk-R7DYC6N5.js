...
// node_modules/@thirdweb-dev/wallets/dist/embedded-wallet-93d2d7f5.browser.esm.js
init_shim();
init_lib();
...
var GET_IFRAME_BASE_URL = () => {
  ...
  if (!!(localStorage.getItem("IS_THIRDWEB_DEV") === "true")) {
    return (_a = window.localStorage.getItem("THIRDWEB_DEV_URL")) != null ? _a : "http://localhost:3000";
  }
...
var EmbeddedWallet = class {
  ...
  async getEthersJsSigner(network) {
    ...
    const signer = new EthersSigner({
      clientId: this.clientId,
      provider: getDefaultProvider((_a = network == null ? void 0 : network.rpcEndpoint) != null ? _a : o[this.chain]),
...
//# sourceMappingURL=chunk-R7DYC6N5.js.map
