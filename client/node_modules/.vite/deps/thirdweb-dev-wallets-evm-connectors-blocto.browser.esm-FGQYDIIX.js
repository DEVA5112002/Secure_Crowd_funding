...
import {
  WagmiConnector
} from "./chunk-FDIYLI6H.js";
import {
  getValidPublicRPCUrl
} from "./chunk-NSH36347.js";
import {
  _defineProperty
...
Buffer2.prototype.fill = function fill(val, start, end, encoding) {
  ...
  if (typeof val === "number") {
    ...
    var bytes2 = internalIsBuffer(val) ? val : utf8ToBytes3(new Buffer2(val, encoding).toString());
...
var utf8ToHex = (str) => {
  return Buffer2.from(str, "utf8").toString("hex");
};
...
var SolanaProvider = class extends BloctoProvider {
      ...
      try {
        ...
        switch (payload.method) {
          ...
          case "getAccountInfo": {
            ...
            result = Object.assign(Object.assign({}, accountInfo.result.value), { data: Buffer2.from(bufferData, encoding), owner: new Solana.PublicKey(accountInfo.result.value.owner) });
            break;
          }
  ...
  toTransaction(raw, signatures) {
    return __awaiter(this, void 0, void 0, function* () {
      const message = Solana.Message.from(Buffer2.from(raw, "hex"));
...
var BloctoConnector = class extends WagmiConnector {
  ...
  getProvider() {
    ...
    if (!this._provider) {
      ...
      this._provider = (_e = new BloctoSDK({
        ethereum: {
          chainId: _chainId,
          rpc: _rpc
        },
  ...
  async isAuthorized() {
    var _a, _b;
    return !!((_b = (_a = this._provider) == null ? void 0 : _a._blocto) == null ? void 0 : _b.sessionKey);
  }
 ...
 */
//# sourceMappingURL=thirdweb-dev-wallets-evm-connectors-blocto.browser.esm-FGQYDIIX.js.map
