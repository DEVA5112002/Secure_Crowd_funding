...
// node_modules/@thirdweb-dev/sdk/dist/QueryParams-e29c2de2.browser.esm.js
init_shim();
init_lib();
...
async function fetchTokenMetadataForContract(contractAddress, provider, tokenId, storage) {
  let uri;
  const ERC165MetadataAbi = (await import("./IERC165-5OCLDTS7.js")).default;
  ...
  if (isERC721) {
    const ERC721MetadataAbi = (await import("./IERC721Metadata-FKT22IYZ.js")).default;
    const erc721 = new Contract(contractAddress, ERC721MetadataAbi, provider);
    uri = await erc721.tokenURI(tokenId);
  } else if (isERC1155) {
    const ERC1155MetadataAbi = (await import("./IERC1155Metadata-HXLQY6DK.js")).default;
...
//# sourceMappingURL=chunk-UDW4GHLE.js.map
