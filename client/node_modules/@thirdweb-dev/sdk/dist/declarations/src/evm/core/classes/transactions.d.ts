...
declare abstract class TransactionContext {
    ...
    abstract estimateGasCost(): Promise<{
        ether: string;
        wei: BigNumber;
    }>;
    /**
 ...
 * @internal
 */
export declare function engineSendFunction(transaction: GaslessTransaction, signer: Signer, provider: providers.Provider, storage: ThirdwebStorage, gaslessOptions?: SDKOptionsOutput["gasless"]): Promise<string>;
