import { b3 as getChainProvider, aN as fetchPublishedContractFromPolygon, aM as THIRDWEB_DEPLOYER$1, aO as fetchAndCacheDeployMetadata, aC as getCreate2FactoryAddress, aK as encodeConstructorParamsForImplementation, aJ as computeDeploymentInfo, aA as isContractDeployed, ab as resolveImplementation, K as fetchContractMetadataFromAddress, at as fetchSourceFilesFromMetadata, a6 as extractConstructorParamsFromAbi, a9 as resolveContractUriFromAddress, aV as getContractPublisherAddress, af as fetchExtendedReleaseMetadata, cu as RPCConnectionHandler, aQ as resolveAddress, Y as getDefaultGasOverrides, aR as signTypedDataInternal, aX as ChainId, cv as ContractWrapper, a_ as NATIVE_TOKEN_ADDRESS, cw as extractFeatures, ag as detectFeatures, aW as getMultichainRegistryAddress, bo as AbiSchema, aw as COMMON_FACTORY, aB as isEIP155Enforced, cx as CUSTOM_GAS_FOR_CHAIN, aL as getCreate2FactoryDeploymentInfo, aT as CONTRACT_ADDRESSES, cy as AddressZero, P as PackInitializer, b as MarketplaceV3Initializer, M as MarketplaceInitializer, f as SplitInitializer, V as VoteInitializer, g as TokenInitializer, T as TokenDropInitializer, a as EditionInitializer, E as EditionDropInitializer, c as MultiwrapInitializer, e as SignatureDropInitializer, N as NFTCollectionInitializer, d as NFTDropInitializer, aH as computeForwarderAddress, h as PREBUILT_CONTRACTS_MAP, k as getContractName, bK as CommonPlatformFeeSchema, bJ as CommonPrimarySaleSchema, bL as CommonTrustedForwarderSchema, bG as CommonContractSchema, bI as CommonRoyaltySchema, bM as CommonSymbolSchema, aF as computeDeploymentAddress, aE as getInitBytecodeWithSalt, aY as setSupportedChains, j as getContractTypeForRemoteName, b8 as getSignerAndProvider, ap as getCompositeABI, b6 as isChainConfig, aU as getContractAddressByChainId, cz as getProcessEnv, bW as DropErc721ContractSchema, i as PREBUILT_CONTRACTS_APPURI_MAP, b2 as EventType } from './index-754ba062.esm.js';
import { isBrowser, ThirdwebStorage } from '@thirdweb-dev/storage';
import { C as ContractPublisher } from './contract-publisher-953b2b3c.esm.js';
...
import { b as buildTransactionFunction, T as Transaction, a as buildDeployTransactionFunction, D as DeployTransaction } from './transactions-5be858b5.esm.js';
import { i as isNativeToken, a as fetchCurrencyValue, C as ContractEncoder } from './fetchCurrencyValue-1af23d09.esm.js';
import EventEmitter from 'eventemitter3';
import invariant from 'tiny-invariant';
import { n as normalizePriceValue } from './normalizePriceValue-d09c889e.esm.js';
import { defaultChains } from '@thirdweb-dev/chains';
import { GENERATED_ABI } from '@thirdweb-dev/generated-abis';
import { g as getDeploymentInfo, c as createTransactionBatches, a as deployWithThrowawayDeployer, d as deployContractDeterministic } from './deployContractDeterministic-929f470a.esm.js';
...
class ThirdwebSDK extends RPCConnectionHandler {
  ...
  async getContractFromAbi(address, abi) {
    const [resolvedAddress, {
      SmartContract
    }] = await Promise.all([resolveAddress(address), import('./smart-contract-c0b72690.esm.js')]);
    if (this.contractCache.has(resolvedAddress)) {
      return this.contractCache.get(resolvedAddress);
    }
