...
class MagicEdenConnector extends evm_connectors_injected_dist_thirdwebDevWalletsEvmConnectorsInjected.InjectedConnector {
  constructor(arg) {
    const defaultOptions = {
      name: "Magic Eden",
      shimDisconnect: true,
      shimChainChangedDisconnect: true,
      getProvider: getInjectedMagicEdenProvider.getInjectedMagicEdenProvider
    };
    const options = {
      ...defaultOptions,
      ...arg.options
    ...
    defineProperty._defineProperty(this, "id", walletIds.walletIds.magicEden);
  }
