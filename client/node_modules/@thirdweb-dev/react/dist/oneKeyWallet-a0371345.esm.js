...
import { g as googleIconUri, a as appleIconUri, f as facebookIconUri, I as InputSelectionUI, e as emailIcon, T as ToolTip, s as smartWalletIcon } from './Tooltip-f1f794ec.esm.js';
...
function useRainbowWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      rainbowWallet
    } = await import('./safeChainSlug-afcee04e.esm.js').then(function (n) { return n.R; });
...
function useTrustWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      trustWallet
    } = await import('./safeChainSlug-afcee04e.esm.js').then(function (n) { return n.u; });
...
function useMetamask() {
  ...
  return useCallback(async options => {
    const {
      metamaskWallet
    } = await import('./safeChainSlug-afcee04e.esm.js').then(function (n) { return n.n; });
...
function useCoinbaseWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      coinbaseWallet
    } = await import('./safeChainSlug-afcee04e.esm.js').then(function (n) { return n.l; });
...
function useFrameWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      frameWallet
    } = await import('./frameWallet-a4ddfc38.esm.js');
...
function usePaperWallet() {
  ...
  return useCallback(async options => {
    const {
      paperWallet
    } = await import('./paperWallet-02b8f335.esm.js');
...
function useWalletConnectV1() {
  ...
  return useCallback(async options => {
    const {
      walletConnectV1
    } = await import('./walletConnectV1-f6c0d03e.esm.js');
...
function useWalletConnect() {
  ...
  return useCallback(async options => {
    const {
      walletConnect
    } = await import('./safeChainSlug-afcee04e.esm.js').then(function (n) { return n.q; });
