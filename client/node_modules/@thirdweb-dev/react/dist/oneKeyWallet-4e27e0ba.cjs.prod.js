...
const EmbeddedWalletFormUI = props => {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
    ...
    }), props.modalSize === "wide" && hasSocialLogins && enableEmailLogin && /*#__PURE__*/jsxRuntime.jsx(formElements.TextDivider, {
      text: twLocale.connectWallet.or
    }), enableEmailLogin && /*#__PURE__*/jsxRuntime.jsx(Tooltip.InputSelectionUI, {
...
const EmbeddedWalletFormUIScreen = props => {
  const locale = formElements.useTWLocale().wallets.embeddedWallet.emailLoginScreen;
...
const EmbeddedWalletOTPLoginUI = props => {
  ...
  const [emailStatus, setEmailStatus] = React.useState("sending");
      ...
      children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Container, {
        ...
        children: /*#__PURE__*/jsxRuntime.jsxs("form", {
          ...
          children: [/*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
            ...
            children: [emailStatus === "error" && /*#__PURE__*/jsxRuntime.jsx(jsxRuntime.Fragment, {
              children: /*#__PURE__*/jsxRuntime.jsx(formElements.Text, {
                size: "sm",
                center: true,
                color: "danger",
            ...
            }), emailStatus === "sending" && /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
              flex: "row",
              center: "both",
              gap: "xs",
              style: {
            ...
            }), typeof emailStatus === "object" && /*#__PURE__*/jsxRuntime.jsx(LinkButton, {
              onClick: sendEmail,
              type: "button",
...
`;
const SkeletonDiv = /* @__PURE__ */formElements.StyledDiv(() => {
  const theme = formElements.useCustomTheme();
  return {
  ...
  if (isLoading) {
    return /*#__PURE__*/jsxRuntime.jsx(formElements.Container, {
      ...
      children: /*#__PURE__*/jsxRuntime.jsx(NetworkListUl, {
        children: new Array(10).fill(0).map((_, i) => /*#__PURE__*/jsxRuntime.jsx(Skeleton, {
          height: "48px"
        }, i))
      })
    });
...
function useEmbeddedWalletUserEmail() {
  ...
  const emailQuery = reactQuery.useQuery([wallet?.walletId, "embeddedWallet-email"], () => {
...
const ConnectedWalletDetails = props => {
  ...
  let content = /*#__PURE__*/jsxRuntime.jsxs("div", {
    children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Spacer, {
      ...
      px: "lg",
      children: [/*#__PURE__*/jsxRuntime.jsx(ConnectedToSmartWallet, {}), /*#__PURE__*/jsxRuntime.jsx(EmbeddedWalletEmail, {}), /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
    ...
    }), props.hideSendButton && props.hideReceiveButton ? null : /*#__PURE__*/jsxRuntime.jsx(formElements.Spacer, {
      y: "md"
    }), /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
      px: "md",
      children: [/*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
        ...
        children: [networkSwitcherButton, personalWallet && personalWalletConfig && !props.hideSwitchToPersonalWallet && /*#__PURE__*/jsxRuntime.jsx(WalletSwitcher, {
...
function useRainbowWallet() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      rainbowWallet
    } = await Promise.resolve().then(function () { return require('./safeChainSlug-d64d6e2a.cjs.prod.js'); }).then(function (n) { return n.RainbowWallet; });
...
function useTrustWallet() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      trustWallet
    } = await Promise.resolve().then(function () { return require('./safeChainSlug-d64d6e2a.cjs.prod.js'); }).then(function (n) { return n.TrustWallet; });
...
function useMetamask() {
  ...
  return React.useCallback(async options => {
    const {
      metamaskWallet
    } = await Promise.resolve().then(function () { return require('./safeChainSlug-d64d6e2a.cjs.prod.js'); }).then(function (n) { return n.metamaskWallet$1; });
...
function useCoinbaseWallet() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      coinbaseWallet
    } = await Promise.resolve().then(function () { return require('./safeChainSlug-d64d6e2a.cjs.prod.js'); }).then(function (n) { return n.coinbaseWallet$1; });
...
function useFrameWallet() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      frameWallet
    } = await Promise.resolve().then(function () { return require('./frameWallet-c27459d2.cjs.prod.js'); });
...
function usePaperWallet() {
  ...
  return React.useCallback(async options => {
    const {
      paperWallet
    } = await Promise.resolve().then(function () { return require('./paperWallet-99964f1b.cjs.prod.js'); });
...
function useWalletConnectV1() {
  ...
  return React.useCallback(async options => {
    const {
      walletConnectV1
    } = await Promise.resolve().then(function () { return require('./walletConnectV1-873b6e10.cjs.prod.js'); });
...
function useWalletConnect() {
  ...
  return React.useCallback(async options => {
    const {
      walletConnect
    } = await Promise.resolve().then(function () { return require('./safeChainSlug-d64d6e2a.cjs.prod.js'); }).then(function (n) { return n.walletConnect$1; });
