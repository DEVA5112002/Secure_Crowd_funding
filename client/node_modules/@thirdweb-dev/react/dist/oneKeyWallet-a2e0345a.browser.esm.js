...
import { b as useTWLocale, u as useCustomTheme, C as Container, I as Img, p as TextDivider, q as useScreenContext, f as ModalConfigCtx, M as ModalHeader, S as Spacer, B as Button, s as spacing, g as fontSize, i as iconSize, T as Text, d as Spinner, a as StyledDiv, t as fadeInAnimation, v as Input, w as media, L as Line, x as InputContainer, y as InputButton, z as IconButton, A as StyledButton, D as reservedScreens, c as ModalDescription, e as Label, E as ScreenBottomContainer, F as StyledP, G as modalCloseFadeOutDuration, H as wideModalMaxHeight, J as modalMaxWidthCompact, K as modalMaxWidthWide, N as compactModalMaxHeight, r as radius, O as shadow, P as noScrollBar, Q as CustomThemeProvider, R as ModalTitle, U as StyledUl, V as onModalUnmount, W as Link, n as useSetIsWalletModalOpen, X as SetModalConfigCtx, Y as canFitWideModal, Z as useSetupScreen, m as useIsWalletModalOpen, _ as ScreenSetupContext, $ as defaultTheme, a0 as WalletUIStatesProvider, a1 as ThirdwebLocaleContext, k as en } from './formElements-556d0493.browser.esm.js';
...
import React, { useContext, useState, useRef, useEffect, useCallback, useDeferredValue, useMemo, memo, Suspense, lazy } from 'react';
...
import { g as googleIconUri, a as appleIconUri, f as facebookIconUri, I as InputSelectionUI, e as emailIcon, T as ToolTip, s as smartWalletIcon } from './Tooltip-4592ae25.browser.esm.js';
import { T as TOS, P as PoweredByThirdweb, W as WalletEntryButton, F as FormFieldWithIconButton, Q as QRCode, i as isMobile, s as safeChainIdToSlug, w as wait, b as WalletLogoSpinner, e as WalletSelector, H as HeadlessConnectUI, f as detectOS, d as defaultWallets, E as ExtensionOrWCConnectionUI } from './safeChainSlug-bca88c60.browser.esm.js';
...
const embeddedWallet = options => {
  ...
  if (finalOptions?.auth?.options.length === 1 && finalOptions.auth.options[0] === "email") {
    name = "Email";
  }
...
const ConnectedWalletDetails = props => {
  ...
  let content = /*#__PURE__*/jsxs("div", {
    ...
    }), props.hideSendButton && props.hideReceiveButton ? null : /*#__PURE__*/jsx(Spacer, {
      y: "md"
    }), /*#__PURE__*/jsxs(Container, {
      px: "md",
      children: [/*#__PURE__*/jsxs(Container, {
...
function useRainbowWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      rainbowWallet
    } = await import('./safeChainSlug-bca88c60.browser.esm.js').then(function (n) { return n.R; });
...
function useTrustWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      trustWallet
    } = await import('./safeChainSlug-bca88c60.browser.esm.js').then(function (n) { return n.u; });
...
function useMetamask() {
  ...
  return useCallback(async options => {
    const {
      metamaskWallet
    } = await import('./safeChainSlug-bca88c60.browser.esm.js').then(function (n) { return n.n; });
...
function useCoinbaseWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      coinbaseWallet
    } = await import('./safeChainSlug-bca88c60.browser.esm.js').then(function (n) { return n.l; });
...
function useFrameWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      frameWallet
    } = await import('./frameWallet-14827aea.browser.esm.js');
...
function usePaperWallet() {
  ...
  return useCallback(async options => {
    const {
      paperWallet
    } = await import('./paperWallet-a86bf149.browser.esm.js');
...
function useWalletConnectV1() {
  ...
  return useCallback(async options => {
    const {
      walletConnectV1
    } = await import('./walletConnectV1-9a7c898e.browser.esm.js');
...
function useWalletConnect() {
  ...
  return useCallback(async options => {
    const {
      walletConnect
    } = await import('./safeChainSlug-bca88c60.browser.esm.js').then(function (n) { return n.q; });
