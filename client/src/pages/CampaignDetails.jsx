...
<div className='mt-[20px] flex flex-row item-center flex-wrap gap-[14px]'>
  ...
  <div >
       <h4 className='font-epilogue font-semibold text-[14px] text-white break-before-all'>{state.owner}</h4>

       <p className='mt-[4px] font-epilogue font-normal text-[12px] text-[#808191]'>10 </p>
        </div>
</div>
</div>
...
<p className='font-epilogue font-normal text-[16px] text-[#808191] leading-[26px] text-justify'>No Invested Yet </p>
...
<div className='flex-1'>
      ...
      <div className='mt-[20px] flex flex-col p-4 bg[#1c1c24] rounded-[10px]'>
         ...
         <div className='my-[20px] p-4 bg-[#13131a] rounded-[10px]'>
               ...
               <p className='mt-[20px] font-epilogue font-normal leading-[22px] text-[#808191]'> Support the project for no rewrd, just because it speaks to yo .</p>
         </div>
         <Custombutton
         btnType="button"
         title="Fund Campaign"
